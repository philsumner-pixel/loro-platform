          ...
          <form action="/api/subscribe" method="POST" style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
            ...
            <div>
              ...
              <input type="email" name="email" required placeholder="your@email.com"
                style={{ width: '100%', padding: '11px 14px', border: '1px solid var(--border)', fontSize: 14, color: 'var(--ink)', background: 'var(--bg)', outline: 'none', fontFamily: "'Inter', sans-serif", boxSizing: 'border-box' }} />
            </div>
            ...
            <button type="submit"
              style={{ padding: '12px 28px', background: 'var(--ink)', color: '#fff', border: 'none', fontSize: 13, fontWeight: 500, cursor: 'pointer', letterSpacing: '0.04em', fontFamily: "'Inter', sans-serif', alignSelf: 'flex-start'" }}>
              Subscribe free →
            </button>
