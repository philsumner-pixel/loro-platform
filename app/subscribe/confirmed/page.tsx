    ...
    <>
      ...
      <div className="loro-wrap" style={{ padding: '80px 0', maxWidth: 540 }}>
        ...
        <h1 style={{ fontFamily: "'Playfair Display', serif", fontSize: 28, fontWeight: 700, color: 'var(--ink)', marginBottom: 16, lineHeight: 1.2 }}>
          {isB2B ? 'Request received.' : "You're subscribed."}
        </h1>
        <p style={{ fontSize: 15, color: 'var(--ink4)', lineHeight: 1.75, marginBottom: 32 }}>
          {isB2B
            ? "We'll review your request and be in touch within 48 hours. Early access to Loro Intelligence is limited — we're prioritising institutional investors, payments executives and M&A professionals in the first cohort."
            : 'Loro Weekly lands every Friday morning. Plain English, what moved in payments, what it means. No noise.'}
        </p>
